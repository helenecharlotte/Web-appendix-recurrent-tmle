...
- Simulation recurrent events data
...
Full reproduction of the simulation study reported in the manuscript
involves a large number of repetitions and may require many hours on a
standard desktop machine. The examples below illustrate usage of the
simulation and estimation functions on single datasets or reduced
settings.
...
#+RESULTS[(2025-12-15 20:58:43) 9384e336237f0f9719ce7a7138bbd30b7f33d5c2]:
#+begin_example
            g.est          tmle.est           tmle.se positivity.issues 
